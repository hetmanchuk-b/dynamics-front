      ...
      <div className={twMerge(
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <a href="/" className="cursor-pointer block">
            <img src="/public/assets/img/logo-blue.svg" className="xl:hidden" width="55" height="35" alt="ADR Dynamics" />
            <img src="/public/assets/img/logo-full-blue.svg" className="xl:block hidden" width="307" height="35" alt="ADR Dynamics" />
          </a>
          ...
          <div className="hidden lg:block">
            <div className="flex items-center gap-2 justify-center">
              <a href="/" className="flex items-center justify-center size-[67px] rounded-full relative group">
                ...
                {isWhite ? (
                  <img src="/public/assets/img/icons/instagram-blue.svg" width="20" height="20" className="relative z-20" alt=""/>
                ) : (
                  <img src="/public/assets/img/icons/instagram.svg" width="20" height="20" className="relative z-20" alt=""/>
                )}
              ...
              <a href="/" className="flex items-center justify-center size-[67px] rounded-full relative group">
                <img src="/public/assets/img/socials-border.svg" className="absolute inset-0 object-cover transition z-10 group-hover:opacity-50" alt=""/>
                {isWhite ? (
                  <img src="/public/assets/img/icons/facebook-blue.svg" width="10" height="18" className="relative z-20" alt=""/>
                ) : (
                  <img src="/public/assets/img/icons/facebook.svg" width="10" height="18" className="relative z-20" alt=""/>
                )}
