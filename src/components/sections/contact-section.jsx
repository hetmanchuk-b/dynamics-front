...
export default function ContactSection() {
  return (
    <section className="relative xl:min-h-[700px] 3xl:min-h-[850px] xl:flex xl:flex-col">
      <img src="/public/assets/img/contact-bg-mob.jpg" className="absolute z-10 inset-0 w-full h-full object-cover lg:hidden" alt=""/>
      <img src="/public/assets/img/contact-bg.jpg" className="absolute z-10 inset-0 w-full h-full object-cover hidden lg:block" alt=""/>
