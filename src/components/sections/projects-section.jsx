  ...
  return (
    <section className="bg-white pt-20 border-b border-borders">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-5 px-[25px] pt-10 pb-5 lg:hidden">
        <img src="/public/assets/img/gallery/1.jpg" className="col-span-full sm:col-start-1 sm:col-end-4 w-full" alt=""/>
        <img src="/public/assets/img/gallery/2.jpg" className="w-full sm:col-start-4 sm:col-end-6" alt=""/>
        <img src="/public/assets/img/gallery/3.jpg" className="w-full sm:col-start-1 sm:col-end-3" alt=""/>
        <img src="/public/assets/img/gallery/4.jpg" className="col-span-full sm:col-start-3 sm:col-end-5 w-full" alt=""/>
      </div>
